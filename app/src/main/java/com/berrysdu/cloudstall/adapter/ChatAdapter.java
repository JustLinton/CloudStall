        ...
        if (holderView == null) {
            ...
            if (isMeSend) {
                arg1 = View.inflate(context, R.layout.chat_dialog_right_item,
                        null);
                CircleImageView civ=arg1.findViewById(R.id.iv_chat_imagr_right);
                ...
                arg1 = View.inflate(context, R.layout.chat_dialog_left_item,
                        null);
                CircleImageView civ=arg1.findViewById(R.id.ivicon);
                civ.setBorderWidth(0);
                ((TextView) arg1.findViewById(R.id.tvname)).setText(entity.getChatMessage());
